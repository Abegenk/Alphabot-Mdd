...
⚠️ Segala kebijakan dan ketentuan MlsidBot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan MlsidBot
😖🙏
`
}
exports.welcome = () =>{
...
exports.leave = () =>{
	return`Yah kok out 😣 Mental aman kan Ngab >.<
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Recode : https://youtube.com/playlist?list=PLFCglBzFPHG7vSaa9S3P8yfla_d9w-2-
`
}
